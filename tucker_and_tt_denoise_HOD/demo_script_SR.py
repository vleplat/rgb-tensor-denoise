...
def main(image_path="Datasets/SR_Innopolis_Cropped.jpg", sigma1=0.001, sigma2=0.01, method="tt_adaptive", reshape_for_tt=False, chosen_order = 6, n_segments=40, compactness=30, patch_size = 6):
