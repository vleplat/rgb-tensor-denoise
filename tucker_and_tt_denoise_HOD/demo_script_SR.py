...
def main(image_path="Datasets/SR_Innopolis_Cropped.jpg", sigma1=0.001, sigma2=0.02, method="tt_adaptive", reshape_for_tt=True, chosen_order = 6, n_segments=75, compactness=30, patch_size = 6, save_figures=True):
    ...
    try:
        ...
        image_noise = add_gaussian_noise(image, sigma=sigma1)
        ...
        for segidx, X in Xs:
            ...
            X_hat, _, _ = decompose_and_denoise_patch(X, method=method, sigma=sigma2, reshape_for_tt=reshape_for_tt, target_order=chosen_order)
